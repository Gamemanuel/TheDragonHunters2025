...
class SmartMotionConfig(BaseConfig):
    def __init__(self) -> None:
        ...
    def allowedClosedLoopError(self, allowedError: typing.SupportsFloat, slot: ClosedLoopSlot = ...) -> SmartMotionConfig:
        """
    ...
    def apply(self, config: SmartMotionConfig) -> SmartMotionConfig:
        ...
        """
    def maxAcceleration(self, maxAcceleration: typing.SupportsFloat, slot: ClosedLoopSlot = ...) -> SmartMotionConfig:
        """
        ...
        :returns: The modified SmartMotionConfig object for method chaining
        """
    def maxVelocity(self, maxVelocity: typing.SupportsFloat, slot: ClosedLoopSlot = ...) -> SmartMotionConfig:
        """
        ...
        :returns: The modified SmartMotionConfig object for method chaining
        """
    def minOutputVelocity(self, minVelocity: typing.SupportsFloat, slot: ClosedLoopSlot = ...) -> SmartMotionConfig:
        """
...
class SparkClosedLoopController:
    ...
    def setIAccum(self, iAccum: typing.SupportsFloat) -> REVLibError:
        ...
        :returns: REVLibError::kOk if successful
        """
    def setReference(self, value: typing.SupportsFloat, ctrl: SparkLowLevel.ControlType, slot: ClosedLoopSlot = ..., arbFeedforward: typing.SupportsFloat = 0, arbFFUnits: SparkClosedLoopController.ArbFFUnits = ...) -> REVLibError:
        """
        Set the controller reference value based on the selected control mode.
        
        :param value:          The value to set depending on the control mode. For:
...
class SparkLowLevel(wpilib.interfaces._interfaces.MotorController):
    ...
    class PeriodicStatus6:
        def __init__(self) -> None:
            ...
        @property
        def dutyCycleNoSignal(self) -> int:
            ...
        @dutyCycleNoSignal.setter
        def dutyCycleNoSignal(self, arg0: typing.SupportsInt) -> None:
            ...
        @property
    ...
    class SparkModel:
        ...
        def value(self) -> int:
            ...
    kAPIBuildVersion: typing.ClassVar[int] = 3
    kAPIMajorVersion: typing.ClassVar[int] = 233
    kAPIMinorVersion: typing.ClassVar[int] = 0
    kAPIVersion: typing.ClassVar[int] = 132710403
