...
try:
    _lib = cdll.LoadLibrary(join(_root, "lib", "romiVendordep.dll"))
except FileNotFoundError:
    if not exists(join(_root, "lib", "romiVendordep.dll")):
        raise FileNotFoundError("romiVendordep.dll was not found on your system. Is this package correctly installed?")
    raise Exception("romiVendordep.dll could not be loaded. Do you have Visual Studio C++ Redistributible 2019 installed?")
