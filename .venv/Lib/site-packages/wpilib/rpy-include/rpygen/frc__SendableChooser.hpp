...
template <typename T, typename CfgBase = rpygen::EmptyTrampolineCfg>
struct PyTrampolineCfg_SendableChooser :
  frc::PyTrampolineCfg_SendableChooserBase<
  CfgBase
  >
{
...
using PyTrampolineBase_SendableChooser =
  frc::PyTrampoline_SendableChooserBase<
    PyTrampolineBase
    , PyTrampolineCfg>
;

template <typename PyTrampolineBase, typename T, typename PyTrampolineCfg>
struct PyTrampoline_SendableChooser : PyTrampolineBase_SendableChooser<PyTrampolineBase, T, PyTrampolineCfg> {
  using PyTrampolineBase_SendableChooser<PyTrampolineBase, T, PyTrampolineCfg>::PyTrampolineBase_SendableChooser;
...
struct bind_frc__SendableChooser {
  using CopyType [[maybe_unused]] = typename frc::SendableChooser<T>::CopyType;
  struct SendableChooser_Trampoline : frc::PyTrampoline_SendableChooser<typename frc::SendableChooser<T>, T, typename frc::PyTrampolineCfg_SendableChooser<T>>, py::trampoline_self_life_support {
      using RpyBase = frc::PyTrampoline_SendableChooser<typename frc::SendableChooser<T>, T, typename frc::PyTrampolineCfg_SendableChooser<T>>;
  ...
  py::class_<typename frc::SendableChooser<T>, py::smart_holder, SendableChooser_Trampoline, frc::SendableChooserBase> cls_SendableChooser;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SendableChooser
      ...
      .def("onChange", [](frc::SendableChooser<T> *self, std::function<void(T)> fn) {
