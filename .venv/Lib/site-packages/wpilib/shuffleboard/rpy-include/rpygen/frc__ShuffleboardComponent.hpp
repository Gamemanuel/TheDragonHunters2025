...
struct bind_frc__ShuffleboardComponent {
  py::class_<typename frc::ShuffleboardComponent<Derived>, py::smart_holder, frc::ShuffleboardComponentBase> cls_ShuffleboardComponent;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ShuffleboardComponent
      ...
      .def("withPosition", &frc::ShuffleboardComponent<Derived>::WithPosition
        , py::arg("columnIndex"), py::arg("rowIndex")
        , release_gil(), py::return_value_policy::reference_internal
        , py::doc(
