...
struct bind_frc__ShuffleboardWidget {
  py::class_<typename frc::ShuffleboardWidget<Derived>, py::smart_holder, frc::ShuffleboardComponent<Derived>> cls_ShuffleboardWidget;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ShuffleboardWidget
      .def("withWidget", static_cast<Derived& (frc::ShuffleboardWidget<Derived>::*)(BuiltInWidgets)>(&frc::ShuffleboardWidget<Derived>::WithWidget)
        , py::arg("widgetType")
        , release_gil(), py::return_value_policy::reference_internal
        , py::doc(
      ...
      .def("withWidget", static_cast<Derived& (frc::ShuffleboardWidget<Derived>::*)(const WidgetType&)>(&frc::ShuffleboardWidget<Derived>::WithWidget)
        , py::arg("widgetType")
        , release_gil(), py::return_value_policy::reference_internal
        , py::doc(
        "Sets the type of widget used to display the data. If not set, the default\n"
      ...
      .def("withWidget", static_cast<Derived& (frc::ShuffleboardWidget<Derived>::*)(std::string_view)>(&frc::ShuffleboardWidget<Derived>::WithWidget)
        , py::arg("widgetType")
        , release_gil(), py::return_value_policy::reference_internal
        , py::doc(
        "Sets the type of widget used to display the data. If not set, the default\n"
