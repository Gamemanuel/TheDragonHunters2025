...
from . import sysid
__all__ = ['ADIS16448_IMU', 'ADIS16470_IMU', 'ADXL345_I2C', 'ADXL345_SPI', 'ADXL362', 'ADXRS450_Gyro', 'AddressableLED', 'Alert', 'AnalogAccelerometer', 'AnalogEncoder', 'AnalogGyro', 'AnalogInput', 'AnalogOutput', 'AnalogPotentiometer', 'AnalogTrigger', 'AnalogTriggerOutput', 'AnalogTriggerType', 'BuiltInAccelerometer', 'CAN', 'CANData', 'CANStatus', 'Color', 'Color8Bit', 'Compressor', 'CompressorConfigType', 'Counter', 'DMC60', 'DSControlWord', 'DataLogManager', 'DigitalGlitchFilter', 'DigitalInput', 'DigitalOutput', 'DigitalSource', 'DoubleSolenoid', 'DriverStation', 'DutyCycle', 'DutyCycleEncoder', 'Encoder', 'Field2d', 'FieldObject2d', 'I2C', 'IterativeRobotBase', 'Jaguar', 'Joystick', 'LEDPattern', 'LiveWindow', 'Mechanism2d', 'MechanismLigament2d', 'MechanismObject2d', 'MechanismRoot2d', 'MotorControllerGroup', 'MotorSafety', 'NidecBrushless', 'Notifier', 'PS4Controller', 'PS5Controller', 'PWM', 'PWMMotorController', 'PWMSparkFlex', 'PWMSparkMax', 'PWMTalonFX', 'PWMTalonSRX', 'PWMVenom', 'PWMVictorSPX', 'PneumaticHub', 'PneumaticsBase', 'PneumaticsControlModule', 'PneumaticsModuleType', 'PowerDistribution', 'Preferences', 'RadioLEDState', 'Relay', 'RobotBase', 'RobotController', 'RobotState', 'RuntimeType', 'SD540', 'SPI', 'SendableBuilderImpl', 'SendableChooser', 'SendableChooserBase', 'SensorUtil', 'SerialPort', 'Servo', 'SharpIR', 'SmartDashboard', 'Solenoid', 'Spark', 'StadiaController', 'SynchronousInterrupt', 'Talon', 'TimedRobot', 'Timer', 'TimesliceRobot', 'Tracer', 'Ultrasonic', 'Victor', 'VictorSP', 'Watchdog', 'XboxController', 'format_as', 'getCurrentThreadPriority', 'getDeployDirectory', 'getErrorMessage', 'getOperatingDirectory', 'getTime', 'setCurrentThreadPriority', 'sysid', 'wait']
...
class AnalogEncoder(wpiutil._wpiutil.Sendable):
    ...
    def __init__(self, analogInput: AnalogInput) -> None:
        ...
        """
    @typing.overload
    def __init__(self, channel: int, fullRange: float, expectedZero: float) -> None:
        """
        Construct a new AnalogEncoder attached to a specific AnalogIn channel.
        ...
        """
    @typing.overload
    def __init__(self, analogInput: AnalogInput, fullRange: float, expectedZero: float) -> None:
        """
        Construct a new AnalogEncoder attached to a specific AnalogInput.
    ...
    def setInverted(self, inverted: bool) -> None:
        ...
        """
    def setVoltagePercentageRange(self, min: float, max: float) -> None:
        """
...
class DutyCycleEncoder(wpiutil._wpiutil.Sendable):
    ...
    def __init__(self, channel: int, fullRange: float, expectedZero: float) -> None:
        ...
        """
    @typing.overload
    def __init__(self, dutyCycle: DutyCycle, fullRange: float, expectedZero: float) -> None:
        """
        Construct a new DutyCycleEncoder attached to an existing DutyCycle object.
        ...
        """
    @typing.overload
    def __init__(self, digitalSource: DigitalSource, fullRange: float, expectedZero: float) -> None:
        """
        Construct a new DutyCycleEncoder attached to a DigitalSource object.
...
class LEDPattern:
    ...
    class LEDReader:
        ...
        def _pybind11_conduit_v1_(*args, **kwargs):
            ...
        def __init__(self, impl: typing.Callable[[int], AddressableLED.LEDData], size: int) -> None:
            ...
        def size(self) -> int:
            ...
    @staticmethod
    ...
    def off() -> LEDPattern:
        ...
        """
    @staticmethod
    def progressMaskLayer(progressFunction: typing.Callable[[], float]) -> LEDPattern:
        """
        ...
        """
    @staticmethod
    def rainbow(saturation: int, value: int) -> LEDPattern:
        """
    ...
    def solid(color: Color) -> LEDPattern:
        ...
        """
    @staticmethod
    def steps(steps: list[tuple[float, Color]]) -> LEDPattern:
        """
        ...
        """
    def __init__(self, impl: typing.Callable[[LEDPattern.LEDReader, typing.Callable[[int, Color], None]], None]) -> None:
        ...
    @typing.overload
    def applyTo(self, reader: LEDPattern.LEDReader, writer: typing.Callable[[int, Color], None]) -> None:
        ...
    @typing.overload
    def applyTo(self, data: list[AddressableLED.LEDData], writer: typing.Callable[[int, Color], None]) -> None:
        """
    ...
    def applyTo(self, data: list[AddressableLED.LEDData]) -> None:
        ...
        :param data: the current data of the LED strip
        """
    def atBrightness(self, relativeBrightness: float) -> LEDPattern:
        """
    ...
    def breathe(self, period: wpimath.units.seconds) -> LEDPattern:
        ...
        """
    def mapIndex(self, indexMapper: typing.Callable[[int, int], int]) -> LEDPattern:
        """
    ...
    def mask(self, mask: LEDPattern) -> LEDPattern:
        ...
        """
    def offsetBy(self, offset: int) -> LEDPattern:
        """
    ...
    def scrollAtRelativeSpeed(self, velocity: wpimath.units.hertz) -> LEDPattern:
        ...
        """
    def synchronizedBlink(self, signal: typing.Callable[[], bool]) -> LEDPattern:
        """
...
class Notifier:
    ...
    def __init__(self, handler: typing.Callable[[], None]) -> None:
        ...
        """
    def setCallback(self, handler: typing.Callable[[], None]) -> None:
        """
...
class PneumaticHub(PneumaticsBase):
    ...
    class Faults:
        ...
        def Brownout(self) -> int:
            ...
            """
        @Brownout.setter
        def Brownout(self, arg1: int) -> None:
            ...
        @property
        def CanWarning(self) -> int:
            ...
            """
        @CanWarning.setter
        def CanWarning(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel0Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel10Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel11Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel12Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel13Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel14Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel15Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel1Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel2Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel3Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel4Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel5Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel6Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel7Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel8Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel9Fault(self, arg1: int) -> None:
            ...
        @property
        ...
        def CompressorOpen(self, arg1: int) -> None:
            ...
        @property
        ...
        def CompressorOverCurrent(self, arg1: int) -> None:
            ...
        @property
        ...
        def HardwareFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def SolenoidOverCurrent(self, arg1: int) -> None:
            ...
    class StickyFaults:
        """
        ...
        def CanBusOff(self) -> int:
            ...
            """
        @CanBusOff.setter
        def CanBusOff(self, arg1: int) -> None:
            ...
        @property
        def CanWarning(self) -> int:
            """
        ...
        def FirmwareFault(self, arg1: int) -> None:
            ...
        @property
        def HardwareFault(self) -> int:
            """
        ...
        def HasReset(self) -> int:
            ...
            """
        @HasReset.setter
        def HasReset(self, arg1: int) -> None:
            ...
        @property
        def SolenoidOverCurrent(self) -> int:
            """
...
class PowerDistribution(wpiutil._wpiutil.Sendable):
    ...
    class Faults:
        ...
        def Channel0BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel10BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel11BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel12BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel13BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel14BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel15BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel16BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel17BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel18BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel19BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel1BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel20BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel21BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel22BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel23BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel2BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel3BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel4BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel5BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel6BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel7BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel8BreakerFault(self, arg1: int) -> None:
            ...
        @property
        ...
        def Channel9BreakerFault(self, arg1: int) -> None:
            ...
        @property
        def HardwareFault(self) -> int:
            """
...
class RobotController:
    ...
    def setRadioLEDState(state: RadioLEDState) -> None:
        ...
        """
    @staticmethod
    def setTimeSource(supplier: typing.Callable[[], int]) -> None:
        """
...
class SendableChooser(SendableChooserBase):
    ...
    def initSendable(self, builder: wpiutil._wpiutil.SendableBuilder) -> None:
        ...
    def onChange(self, listener: typing.Callable[[typing.Any], None]) -> None:
        """
...
class SharpIR(wpiutil._wpiutil.Sendable):
    @staticmethod
    def GP2Y0A02YK0F(channel: int) -> SharpIR:
        """
        ...
        """
    @staticmethod
    def GP2Y0A21YK0F(channel: int) -> SharpIR:
        """
        ...
        """
    @staticmethod
    def GP2Y0A41SK0F(channel: int) -> SharpIR:
        """
        ...
        """
    @staticmethod
    def GP2Y0A51SK0F(channel: int) -> SharpIR:
        """
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, channel: int, a: float, b: float, minCM: float, maxCM: float) -> None:
        """
...
def _clearSmartDashboardData() -> None:
    ...
def format_as(order: AddressableLED.ColorOrder) -> int:
    ...
