...
class LEDPattern:
    ...
    class LEDReader:
        ...
        """
        def __init__(self, impl: typing.Callable[[typing.SupportsInt], AddressableLED.LEDData], size: typing.SupportsInt) -> None:
            ...
        def size(self) -> int:
            ...
    @staticmethod
    ...
    def steps(steps: list[tuple[typing.SupportsFloat, Color]]) -> LEDPattern:
        ...
        """
    def __init__(self, impl: typing.Callable[[LEDPattern.LEDReader, typing.Callable[[typing.SupportsInt, Color], None]], None]) -> None:
        ...
    @typing.overload
    def applyTo(self, reader: LEDPattern.LEDReader, writer: typing.Callable[[typing.SupportsInt, Color], None]) -> None:
        ...
    @typing.overload
    def applyTo(self, data: list[AddressableLED.LEDData], writer: typing.Callable[[typing.SupportsInt, Color], None]) -> None:
        """
    ...
    def breathe(self, period: wpimath.units.seconds) -> LEDPattern:
        ...
        """
    def mapIndex(self, indexMapper: typing.Callable[[typing.SupportsInt, typing.SupportsInt], int]) -> LEDPattern:
        """
...
class NidecBrushless(wpilib.interfaces._interfaces.MotorController, MotorSafety, wpiutil._wpiutil.Sendable):
    ...
    """
    def __init__(self, pwmChannel: typing.SupportsInt, dioChannel: typing.SupportsInt) -> None:
        """
        Constructor.
