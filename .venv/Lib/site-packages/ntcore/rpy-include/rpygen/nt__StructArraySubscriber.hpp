...
template <typename T, typename I, typename CfgBase = rpygen::EmptyTrampolineCfg>
struct PyTrampolineCfg_StructArraySubscriber :
...
using PyTrampolineBase_StructArraySubscriber =
...
template <typename PyTrampolineBase, typename T, typename I, typename PyTrampolineCfg>
struct PyTrampoline_StructArraySubscriber : PyTrampolineBase_StructArraySubscriber<PyTrampolineBase, T, I, PyTrampolineCfg> {
  using PyTrampolineBase_StructArraySubscriber<PyTrampolineBase, T, I, PyTrampolineCfg>::PyTrampolineBase_StructArraySubscriber;
...
struct bind_nt__StructArraySubscriber {
  ...
  using ParamType [[maybe_unused]] = typename nt::StructArraySubscriber<T, I>::ParamType;
  using TimestampedValueType [[maybe_unused]] = typename nt::StructArraySubscriber<T, I>::TimestampedValueType;
  struct StructArraySubscriber_Trampoline : nt::PyTrampoline_StructArraySubscriber<typename nt::StructArraySubscriber<T, I>, T, I, typename nt::PyTrampolineCfg_StructArraySubscriber<T, I>>, py::trampoline_self_life_support {
      using RpyBase = nt::PyTrampoline_StructArraySubscriber<typename nt::StructArraySubscriber<T, I>, T, I, typename nt::PyTrampolineCfg_StructArraySubscriber<T, I>>;
  ...
  py::class_<typename nt::StructArraySubscriber<T, I>, py::smart_holder, StructArraySubscriber_Trampoline, nt::Subscriber> cls_StructArraySubscriber;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_StructArraySubscriber.doc() = "NetworkTables struct-encoded value array subscriber.";
    cls_StructArraySubscriber
      .def("get", static_cast<ValueType (nt::StructArraySubscriber<T, I>::*)() const>(&nt::StructArraySubscriber<T, I>::Get)
        , release_gil()
        , py::doc(
      ...
      .def("get", static_cast<ValueType (nt::StructArraySubscriber<T, I>::*)(std::span<const T>) const>(&nt::StructArraySubscriber<T, I>::Get)
        , py::arg("defaultValue")
        , release_gil()
        , py::doc(
        "Get the last published value.\n"
      ...
      .def("getAtomic", static_cast<TimestampedValueType (nt::StructArraySubscriber<T, I>::*)() const>(&nt::StructArraySubscriber<T, I>::GetAtomic)
        , release_gil()
        , py::doc(
      ...
      .def("getAtomic", static_cast<TimestampedValueType (nt::StructArraySubscriber<T, I>::*)(std::span<const T>) const>(&nt::StructArraySubscriber<T, I>::GetAtomic)
        , py::arg("defaultValue")
        , release_gil()
        , py::doc(
        "Get the last published value along with its timestamp.\n"
      ...
      .def("readQueue", &nt::StructArraySubscriber<T, I>::ReadQueue
        , release_gil()
        , py::doc(
      ...
      .def("getTopic", &nt::StructArraySubscriber<T, I>::GetTopic
        , release_gil()
        , py::doc(
