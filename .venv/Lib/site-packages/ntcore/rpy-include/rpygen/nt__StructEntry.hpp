...
struct bind_nt__StructEntry {
  ...
  py::class_<typename nt::StructEntry<T, I>, py::smart_holder, nt::StructSubscriber<T, I>, nt::StructPublisher<T, I>> cls_StructEntry;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_StructEntry
      .def("getTopic", &nt::StructEntry<T, I>::GetTopic
        , release_gil()
        , py::doc(
      ...
      .def("unpublish", &nt::StructEntry<T, I>::Unpublish
        , release_gil()
