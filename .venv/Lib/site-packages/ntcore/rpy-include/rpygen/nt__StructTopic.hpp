...
struct bind_nt__StructTopic {
  ...
  py::class_<typename nt::StructTopic<T, I>, py::smart_holder, nt::Topic> cls_StructTopic;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    cls_StructTopic.doc() = "NetworkTables struct-encoded value topic.";
    cls_StructTopic
      ...
      .def("subscribe", &nt::StructTopic<T, I>::Subscribe
      ...
      .def("publish", &nt::StructTopic<T, I>::Publish
      ...
      .def("publishEx", &nt::StructTopic<T, I>::PublishEx
      ...
      .def("getEntry", &nt::StructTopic<T, I>::GetEntry
        , py::arg("defaultValue"), py::arg("options") = kDefaultPubSubOptions
        , release_gil()
        , py::doc(
