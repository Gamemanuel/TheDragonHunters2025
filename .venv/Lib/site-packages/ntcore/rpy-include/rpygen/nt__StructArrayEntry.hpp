...
struct bind_nt__StructArrayEntry {
  ...
  py::class_<typename nt::StructArrayEntry<T, I>, py::smart_holder, nt::StructArraySubscriber<T, I>, nt::StructArrayPublisher<T, I>> cls_StructArrayEntry;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_StructArrayEntry
      .def("getTopic", &nt::StructArrayEntry<T, I>::GetTopic
        , release_gil()
        , py::doc(
      ...
      .def("unpublish", &nt::StructArrayEntry<T, I>::Unpublish
        , release_gil()
        , py::doc("Stops publishing the entry if it's published.")
      )
