...
struct bind_nt__StructArrayPublisher {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_StructArrayPublisher
      .def("set", static_cast<void (nt::StructArrayPublisher<T, I>::*)(std::span<const T>, int64_t)>(&nt::StructArrayPublisher<T, I>::Set)
      ...
      .def("setDefault", static_cast<void (nt::StructArrayPublisher<T, I>::*)(std::span<const T>)>(&nt::StructArrayPublisher<T, I>::SetDefault)
        , py::arg("value")
        , release_gil()
        , py::doc(
      ...
      .def("getTopic", &nt::StructArrayPublisher<T, I>::GetTopic
        , release_gil()
        , py::doc(
