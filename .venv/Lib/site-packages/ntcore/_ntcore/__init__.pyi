...
class NetworkTable:
    ...
    def __contains__(self, arg0: str) -> bool:
        ...
    @typing.overload
    def addListener(self, eventMask: typing.SupportsInt, listener: typing.Callable[[NetworkTable, str, Event], None]) -> int:
        """
        ...
        """
    @typing.overload
    def addListener(self, key: str, eventMask: typing.SupportsInt, listener: typing.Callable[[NetworkTable, str, Event], None]) -> int:
        """
...
class NetworkTableInstance:
    ...
    def addConnectionListener(self, immediate_notify: bool, callback: typing.Callable[[Event], None]) -> int:
        ...
        """
    @typing.overload
    def addListener(self, topic: Topic, eventMask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> int:
        """
        ...
        """
    @typing.overload
    def addListener(self, subscriber: Subscriber, eventMask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> int:
        """
        ...
        """
    @typing.overload
    def addListener(self, subscriber: MultiSubscriber, eventMask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> int:
        """
        Add a listener for changes on a subscriber. The callback
        function is called asynchronously on a separate thread, so it's important
        to use synchronization or atomics when accessing any shared state from the
        ...
        """
    @typing.overload
    def addListener(self, entry: NetworkTableEntry, eventMask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> int:
        """
        ...
        """
    @typing.overload
    def addListener(self, prefixes: list[str], eventMask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> int:
        """
        ...
        :returns: Listener handle
        """
    def addLogger(self, minLevel: typing.SupportsInt, maxLevel: typing.SupportsInt, func: typing.Callable[[Event], None]) -> int:
        """
...
class NetworkTableListener:
    ...
    @staticmethod
    @typing.overload
    def createListener(inst: NetworkTableInstance, prefixes: list[str], mask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
    ...
    @staticmethod
    @typing.overload
    def createListener(topic: Topic, mask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
    ...
    @staticmethod
    @typing.overload
    def createListener(subscriber: Subscriber, mask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
    ...
    @staticmethod
    @typing.overload
    def createListener(subscriber: MultiSubscriber, mask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
        Create a listener for topic changes on a subscriber. This does NOT keep the
        subscriber active.
    ...
    @staticmethod
    @typing.overload
    def createListener(entry: NetworkTableEntry, mask: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
        ...
        """
    @staticmethod
    def createLogger(inst: NetworkTableInstance, minLevel: typing.SupportsInt, maxLevel: typing.SupportsInt, listener: typing.Callable[[Event], None]) -> NetworkTableListener:
        """
...
class TimestampedBooleanArray:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, time: typing.SupportsInt, serverTime: typing.SupportsInt, value: list[typing.SupportsInt]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
    ...
    def value(self) -> list[int]:
        ...
        """
    @value.setter
    def value(self, arg0: list[typing.SupportsInt]) -> None:
        ...
...
class TimestampedDoubleArray:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, time: typing.SupportsInt, serverTime: typing.SupportsInt, value: list[typing.SupportsFloat]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
    ...
    def value(self) -> list[float]:
        ...
        """
    @value.setter
    def value(self, arg0: list[typing.SupportsFloat]) -> None:
        ...
...
class TimestampedStringArray:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, time: typing.SupportsInt, serverTime: typing.SupportsInt, value: list[str]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
...
class TimestampedStructArray:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, time: typing.SupportsInt, serverTime: typing.SupportsInt, value: list[typing.Any]) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
...
class Value:
    ...
    def makeDouble(value: typing.SupportsFloat, time: typing.SupportsInt = 0) -> Value:
        ...
        """
    @staticmethod
    def makeDoubleArray(value: list[typing.SupportsFloat], time: typing.SupportsInt = 0) -> Value:
        """
    ...
    def makeFloat(value: typing.SupportsFloat, time: typing.SupportsInt = 0) -> Value:
        ...
        """
    @staticmethod
    def makeFloatArray(value: list[typing.SupportsFloat], time: typing.SupportsInt = 0) -> Value:
        """
    ...
    def makeInteger(value: typing.SupportsInt, time: typing.SupportsInt = 0) -> Value:
        ...
        """
    @staticmethod
    def makeIntegerArray(value: list[typing.SupportsInt], time: typing.SupportsInt = 0) -> Value:
        """
    ...
    def makeString(value: str, time: typing.SupportsInt = 0) -> Value:
        ...
        """
    @staticmethod
    def makeStringArray(value: list[str], time: typing.SupportsInt = 0) -> Value:
        """
