...
struct bind_frc__SlewRateLimiter {
  ...
  py::class_<typename frc::SlewRateLimiter<Unit>, py::smart_holder> cls_SlewRateLimiter;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SlewRateLimiter
      .def(py::init<Rate_t, Rate_t, Unit_t>()
        , py::arg("positiveRateLimit"), py::arg("negativeRateLimit"), py::arg("initialValue") = Unit_t{0}
        , release_gil()
        , py::doc(
      ...
      .def("lastValue", &frc::SlewRateLimiter<Unit>::LastValue
        , release_gil()
        , py::doc(
