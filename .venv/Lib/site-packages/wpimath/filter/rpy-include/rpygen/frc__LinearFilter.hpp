...
struct bind_frc__LinearFilter {
  py::class_<typename frc::LinearFilter<T>, py::smart_holder> cls_LinearFilter;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_LinearFilter
      ...
      .def_static("singlePoleIIR", &frc::LinearFilter<T>::SinglePoleIIR
        , py::arg("timeConstant"), py::arg("period")
        , release_gil()
        , py::doc(
      ...
      .def("reset", static_cast<void (frc::LinearFilter<T>::*)()>(&frc::LinearFilter<T>::Reset)
        , release_gil()
        , py::doc("Reset the filter state.")
      )
      .def("reset", static_cast<void (frc::LinearFilter<T>::*)(std::span<const T>, std::span<const T>)>(&frc::LinearFilter<T>::Reset)
        , py::arg("inputBuffer"), py::arg("outputBuffer")
        , release_gil()
        , py::doc(
      ...
      .def("lastValue", &frc::LinearFilter<T>::LastValue
        , release_gil()
        , py::doc(
