...
struct bind_frc__MedianFilter {
  py::class_<typename frc::MedianFilter<T>, py::smart_holder> cls_MedianFilter;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_MedianFilter
      ...
      .def("lastValue", &frc::MedianFilter<T>::LastValue
        , release_gil()
        , py::doc(
      ...
      .def("reset", &frc::MedianFilter<T>::Reset
        , release_gil()
        , py::doc("Resets the filter, clearing the window of all elements.")
      )
    ;
    if (set_doc) {
