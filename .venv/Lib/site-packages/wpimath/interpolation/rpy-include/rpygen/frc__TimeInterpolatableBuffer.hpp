...
struct bind_frc__TimeInterpolatableBuffer {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_TimeInterpolatableBuffer
      ...
      .def("clear", &frc::TimeInterpolatableBuffer<T>::Clear
        , release_gil()
      ...
      .def("getInternalBuffer", static_cast<std::vector<std::pair<units::second_t, T>>& (frc::TimeInterpolatableBuffer<T>::*)()>(&frc::TimeInterpolatableBuffer<T>::GetInternalBuffer)
        , release_gil()
        , py::doc(
