...
template <typename WheelSpeeds, typename WheelPositions, typename CfgBase = rpygen::EmptyTrampolineCfg>
...
struct PyTrampoline_Kinematics : PyTrampolineBase {
  ...
  #ifndef RPYGEN_DISABLE_KInterpolate_KRTWheelPositions_KRTWheelPositions_d
    WheelPositions Interpolate(const WheelPositions& start, const WheelPositions& end, double t) const override {
      using LookupBase = typename PyTrampolineCfg::Base;
      RPYBUILD_OVERRIDE_PURE_NAME(Kinematics, PYBIND11_TYPE(WheelPositions), LookupBase,
