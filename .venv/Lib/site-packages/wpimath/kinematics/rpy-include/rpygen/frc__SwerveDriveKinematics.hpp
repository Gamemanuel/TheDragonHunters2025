...
template <size_t NumModules, typename CfgBase = rpygen::EmptyTrampolineCfg>
struct PyTrampolineCfg_SwerveDriveKinematics :
  frc::PyTrampolineCfg_Kinematics<wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>, 
  CfgBase
  >
{
  ...
  using override_base_KToTwist2d_KRTarray_KRTarray = frc::SwerveDriveKinematics<NumModules>;
  using override_base_KInterpolate_KRTarray_KRTarray_d = frc::SwerveDriveKinematics<NumModules>;
};

template <typename PyTrampolineBase, size_t NumModules, typename PyTrampolineCfg>
using PyTrampolineBase_SwerveDriveKinematics =
  frc::PyTrampoline_Kinematics<
    PyTrampolineBase
    , wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>
    , PyTrampolineCfg>
;

template <typename PyTrampolineBase, size_t NumModules, typename PyTrampolineCfg>
struct PyTrampoline_SwerveDriveKinematics : PyTrampolineBase_SwerveDriveKinematics<PyTrampolineBase, NumModules, PyTrampolineCfg> {
  using PyTrampolineBase_SwerveDriveKinematics<PyTrampolineBase, NumModules, PyTrampolineCfg>::PyTrampolineBase_SwerveDriveKinematics;
    ...
    wpi::array<SwerveModuleState, NumModules> ToWheelSpeeds(const ChassisSpeeds& chassisSpeeds) const override {
      ...
      PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(wpi::array<SwerveModuleState, NumModules>), LookupBase,
  ...
  #ifndef RPYGEN_DISABLE_KToTwist2d_KRTarray_KRTarray
    Twist2d ToTwist2d(const wpi::array<SwerveModulePosition, NumModules>& start, const wpi::array<SwerveModulePosition, NumModules>& end) const override {
      using LookupBase = typename PyTrampolineCfg::Base;
      using CxxCallBase = typename PyTrampolineCfg::override_base_KToTwist2d_KRTarray_KRTarray;
  ...
  #ifndef RPYGEN_DISABLE_KInterpolate_KRTarray_KRTarray_d
    wpi::array<SwerveModulePosition, NumModules> Interpolate(const wpi::array<SwerveModulePosition, NumModules>& start, const wpi::array<SwerveModulePosition, NumModules>& end, double t) const override {
      using LookupBase = typename PyTrampolineCfg::Base;
      using CxxCallBase = typename PyTrampolineCfg::override_base_KInterpolate_KRTarray_KRTarray_d;
      PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(wpi::array<SwerveModulePosition, NumModules>), LookupBase,
...
struct bind_frc__SwerveDriveKinematics {
  struct SwerveDriveKinematics_Trampoline : frc::PyTrampoline_SwerveDriveKinematics<typename frc::SwerveDriveKinematics<NumModules>, NumModules, typename frc::PyTrampolineCfg_SwerveDriveKinematics<NumModules>>, py::trampoline_self_life_support {
      using RpyBase = frc::PyTrampoline_SwerveDriveKinematics<typename frc::SwerveDriveKinematics<NumModules>, NumModules, typename frc::PyTrampolineCfg_SwerveDriveKinematics<NumModules>>;
  ...
  py::class_<typename frc::SwerveDriveKinematics<NumModules>, py::smart_holder, SwerveDriveKinematics_Trampoline, frc::Kinematics<wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>>> cls_SwerveDriveKinematics;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SwerveDriveKinematics
      .def("resetHeadings", static_cast<void (frc::SwerveDriveKinematics<NumModules>::*)(wpi::array<Rotation2d, NumModules>)>(&frc::SwerveDriveKinematics<NumModules>::ResetHeadings)
        , py::arg("moduleHeadings")
        , release_gil()
        , py::doc(
      ...
      .def("toSwerveModuleStates", &frc::SwerveDriveKinematics<NumModules>::ToSwerveModuleStates
        , py::arg("chassisSpeeds"), py::arg("centerOfRotation") = Translation2d{}
        , release_gil()
        , py::doc(
      ...
      .def("toWheelSpeeds", &frc::SwerveDriveKinematics<NumModules>::ToWheelSpeeds
        , py::arg("chassisSpeeds")
        , release_gil()
      )
      .def("toChassisSpeeds", static_cast<ChassisSpeeds (frc::SwerveDriveKinematics<NumModules>::*)(const wpi::array<SwerveModuleState, NumModules>&) const>(&frc::SwerveDriveKinematics<NumModules>::ToChassisSpeeds)
        , py::arg("moduleStates")
        , release_gil()
        , py::doc(
      ...
      .def("toTwist2d", static_cast<Twist2d (frc::SwerveDriveKinematics<NumModules>::*)(wpi::array<SwerveModulePosition, NumModules>) const>(&frc::SwerveDriveKinematics<NumModules>::ToTwist2d)
        , py::arg("moduleDeltas")
        , release_gil()
        , py::doc(
      ...
      .def("toTwist2d", static_cast<Twist2d (frc::SwerveDriveKinematics<NumModules>::*)(const wpi::array<SwerveModulePosition, NumModules>&, const wpi::array<SwerveModulePosition, NumModules>&) const>(&frc::SwerveDriveKinematics<NumModules>::ToTwist2d)
      ...
      .def_static("desaturateWheelSpeeds", [](wpi::array<SwerveModuleState, NumModules> moduleStates, units::meters_per_second_t attainableMaxSpeed) {
        ...
        , py::arg("moduleStates"), py::arg("attainableMaxSpeed")
        , py::doc(
      ...
      .def_static("desaturateWheelSpeeds", [](wpi::array<SwerveModuleState, NumModules> moduleStates,
        ...
        , py::arg("moduleStates"), py::arg("desiredChassisSpeed"), py::arg("attainableMaxModuleSpeed"), py::arg("attainableMaxRobotTranslationSpeed"), py::arg("attainableMaxRobotRotationSpeed")
        , py::doc(
        "Renormalizes the wheel speeds if any individual speed is above the\n"
      ...
      .def("interpolate", &frc::SwerveDriveKinematics<NumModules>::Interpolate
        , py::arg("start"), py::arg("end"), py::arg("t")
        , release_gil()
      )
      .def("getModules", &frc::SwerveDriveKinematics<NumModules>::GetModules
        , release_gil()
      )
    ;
    if (set_doc) {
