...
struct bind_frc__SwerveDriveKinematics {
  ...
  py::class_<typename frc::SwerveDriveKinematics<NumModules>, SwerveDriveKinematics_Trampoline, frc::Kinematics<wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>>> cls_SwerveDriveKinematics;
