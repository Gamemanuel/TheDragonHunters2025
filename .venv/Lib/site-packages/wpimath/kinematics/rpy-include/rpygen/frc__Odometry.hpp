...
struct bind_frc__Odometry {
  py::class_<typename frc::Odometry<WheelSpeeds, WheelPositions>, py::smart_holder> cls_Odometry;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_Odometry
      .def(py::init<const Kinematics<WheelSpeeds, WheelPositions>&, const Rotation2d&, const WheelPositions&, const Pose2d&>()
        , py::arg("kinematics"), py::arg("gyroAngle"), py::arg("wheelPositions"), py::arg("initialPose") = Pose2d{}
      ...
      .def("resetPosition", &frc::Odometry<WheelSpeeds, WheelPositions>::ResetPosition
      ...
      .def("resetPose", &frc::Odometry<WheelSpeeds, WheelPositions>::ResetPose
        , py::arg("pose")
        , release_gil()
        , py::doc(
        "Resets the pose.\n"
      ...
      .def("resetTranslation", &frc::Odometry<WheelSpeeds, WheelPositions>::ResetTranslation
        , py::arg("translation")
        , release_gil()
        , py::doc(
      ...
      .def("resetRotation", &frc::Odometry<WheelSpeeds, WheelPositions>::ResetRotation
        , py::arg("rotation")
        , release_gil()
        , py::doc(
      ...
      .def("getPose", &frc::Odometry<WheelSpeeds, WheelPositions>::GetPose
        , release_gil()
        , py::doc(
      ...
      .def("update", &frc::Odometry<WheelSpeeds, WheelPositions>::Update
