...
class DCMotor:
    ...
    """
    WPIStruct: typing.ClassVar[typing.Any]  # value = <capsule object "WPyStruct" at 0x0000025310BB6E50>
    @staticmethod
...
class LinearSystemId:
    ...
    def drivetrainVelocitySystem(motor: DCMotor, mass: wpimath.units.kilograms, r: wpimath.units.meters, rb: wpimath.units.meters, J: wpimath.units.kilogram_square_meters, gearing: float) -> wpimath._controls._controls.system.LinearSystem_2_2_2:
        ...
        """
    @staticmethod
    def elevatorSystem(motor: DCMotor, mass: wpimath.units.kilograms, radius: wpimath.units.meters, gearing: float) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
    ...
    def identifyVelocitySystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_1_1_1:
        ...
    @staticmethod
    def singleJointedArmSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, gearing: float) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
