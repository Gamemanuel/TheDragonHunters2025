...
class DCMotor:
    ...
    """
    WPIStruct: typing.ClassVar[typing.Any]  # value = <capsule object "WPyStruct" at 0x00000189A413B8A0>
    @staticmethod
    def CIM(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of CIM motors.
        """
    @staticmethod
    def NEO(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of NEO brushless motors.
        """
    @staticmethod
    def NEO550(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of NEO 550 brushless motors.
        """
    @staticmethod
    def RS775_125(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Andymark RS 775-125 motors.
        """
    @staticmethod
    def andymark9015(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Andymark 9015 motors.
        """
    @staticmethod
    def bag(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Bag motor motors.
        """
    @staticmethod
    def banebotsRS550(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Banebots RS 550 motors.
        """
    @staticmethod
    def banebotsRS775(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Banebots RS 775 motors.
        """
    @staticmethod
    def falcon500(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Falcon 500 brushless motors.
        """
    @staticmethod
    def falcon500FOC(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Return a gearbox of Falcon 500 motors with FOC (Field-Oriented Control)
        enabled.
        """
    @staticmethod
    def krakenX60(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Return a gearbox of Kraken X60 brushless motors.
        """
    @staticmethod
    def krakenX60FOC(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Return a gearbox of Kraken X60 brushless motors with FOC (Field-Oriented
        Control) enabled.
        """
    @staticmethod
    def miniCIM(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of MiniCIM motors.
        """
    @staticmethod
    def neoVortex(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Return a gearbox of Neo Vortex brushless motors.
        """
    @staticmethod
    def romiBuiltIn(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Return a gearbox of Romi/TI_RSLK MAX motors.
        """
    @staticmethod
    def vex775Pro(numMotors: typing.SupportsInt = 1) -> DCMotor:
        """
        Returns a gearbox of Vex 775 Pro motors.
        """
    def __init__(self, nominalVoltage: wpimath.units.volts, stallTorque: wpimath.units.newton_meters, stallCurrent: wpimath.units.amperes, freeCurrent: wpimath.units.amperes, freeSpeed: wpimath.units.radians_per_second, numMotors: typing.SupportsInt = 1) -> None:
        """
    ...
    def current(self, speed: wpimath.units.radians_per_second, inputVoltage: wpimath.units.volts) -> wpimath.units.amperes:
        ...
        """
    @typing.overload
    def current(self, torque: wpimath.units.newton_meters) -> wpimath.units.amperes:
        """
    ...
    def voltage(self, torque: wpimath.units.newton_meters, speed: wpimath.units.radians_per_second) -> wpimath.units.volts:
        ...
        :param speed:  The current angular velocity of the motor.
        """
    def withReduction(self, gearboxReduction: typing.SupportsFloat) -> DCMotor:
        """
...
class LinearSystemId:
    ...
    @staticmethod
    @typing.overload
    def DCMotorSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, gearing: typing.SupportsFloat) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
    ...
    def DCMotorSystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        ...
    @staticmethod
    def drivetrainVelocitySystem(motor: DCMotor, mass: wpimath.units.kilograms, r: wpimath.units.meters, rb: wpimath.units.meters, J: wpimath.units.kilogram_square_meters, gearing: typing.SupportsFloat) -> wpimath._controls._controls.system.LinearSystem_2_2_2:
        """
        ...
        """
    @staticmethod
    def elevatorSystem(motor: DCMotor, mass: wpimath.units.kilograms, radius: wpimath.units.meters, gearing: typing.SupportsFloat) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
        ...
        """
    @staticmethod
    def flywheelSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, gearing: typing.SupportsFloat) -> wpimath._controls._controls.system.LinearSystem_1_1_1:
        """
    ...
    def identifyDrivetrainSystem(kVLinear: wpimath.units.volt_seconds_per_meter, kALinear: wpimath.units.volt_seconds_squared_per_meter, kVAngular: wpimath.units.volt_seconds_per_radian, kAAngular: wpimath.units.volt_seconds_squared_per_radian, trackwidth: wpimath.units.meters) -> wpimath._controls._controls.system.LinearSystem_2_2_2:
        ...
        """
    @staticmethod
    def identifyPositionSystemMeters(kV: wpimath.units.volt_seconds_per_meter, kA: wpimath.units.volt_seconds_squared_per_meter) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
        ...
        """
    @staticmethod
    def identifyPositionSystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        ...
    @staticmethod
    ...
    def identifyVelocitySystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_1_1_1:
        ...
    @staticmethod
    def singleJointedArmSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, gearing: typing.SupportsFloat) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
