...
struct bind_frc__ExtendedKalmanFilter {
  ...
  py::class_<typename frc::ExtendedKalmanFilter<States, Inputs, Outputs>, py::smart_holder> cls_ExtendedKalmanFilter;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ExtendedKalmanFilter
      .def(py::init<std::function<StateVector (const StateVector&, const InputVector&)>, std::function<OutputVector (const StateVector&, const InputVector&)>, const StateArray&, const OutputArray&, units::second_t>()
        , py::arg("f").none(false), py::arg("h").none(false), py::arg("stateStdDevs"), py::arg("measurementStdDevs"), py::arg("dt")
        , release_gil(), py::keep_alive<1, 4>(), py::keep_alive<1, 5>()
        , py::doc(
      ...
      .def(py::init<std::function<StateVector (const StateVector&, const InputVector&)>, std::function<OutputVector (const StateVector&, const InputVector&)>, const StateArray&, const OutputArray&, std::function<OutputVector (const OutputVector&, const OutputVector&)>, std::function<StateVector (const StateVector&, const StateVector&)>, units::second_t>()
        , py::arg("f").none(false), py::arg("h").none(false), py::arg("stateStdDevs"), py::arg("measurementStdDevs"), py::arg("residualFuncY").none(false), py::arg("addFuncX").none(false), py::arg("dt")
        , release_gil(), py::keep_alive<1, 4>(), py::keep_alive<1, 5>()
        , py::doc(
        "Constructs an extended Kalman filter.\n"
        "\n"
      ...
      .def("P", static_cast<const StateMatrix& (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)() const>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::P)
        , release_gil()
        , py::doc("Returns the error covariance matrix P.")
      )
      .def("P", static_cast<double (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(int, int) const>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::P)
        , py::arg("i"), py::arg("j")
        , release_gil()
        , py::doc(
      ...
      .def("xhat", static_cast<const StateVector& (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)() const>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::Xhat)
        , release_gil()
        , py::doc("Returns the state estimate x-hat.")
      )
      .def("xhat", static_cast<double (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(int) const>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::Xhat)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(const StateVector&)>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::SetXhat)
        , py::arg("xHat")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(int, double)>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::SetXhat)
      ...
      .def("reset", &frc::ExtendedKalmanFilter<States, Inputs, Outputs>::Reset
        , release_gil()
        , py::doc("Resets the observer.")
      )
      ...
      .def("correct", static_cast<void (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(const InputVector&, const OutputVector&)>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::Correct)
        , py::arg("u"), py::arg("y")
        , release_gil()
        , py::doc(
      ...
      .def("correct", static_cast<void (frc::ExtendedKalmanFilter<States, Inputs, Outputs>::*)(const InputVector&, const OutputVector&, const Matrixd<Outputs, Outputs>&)>(&frc::ExtendedKalmanFilter<States, Inputs, Outputs>::Correct)
        , py::arg("u"), py::arg("y"), py::arg("R")
        , release_gil()
        , py::doc(
        "Correct the state estimate x-hat using the measurements in y.\n"
        "\n"
