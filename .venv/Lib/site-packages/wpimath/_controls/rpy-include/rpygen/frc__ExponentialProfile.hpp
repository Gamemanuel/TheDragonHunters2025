...
struct bind_frc__ExponentialProfile {
  ...
  py::class_<typename frc::ExponentialProfile<Distance, Input>, py::smart_holder> cls_ExponentialProfile;
  py::class_<typename frc::ExponentialProfile<Distance, Input>::ProfileTiming, py::smart_holder> cls_ProfileTiming;
  py::class_<typename frc::ExponentialProfile<Distance, Input>::Constraints, py::smart_holder> cls_Constraints;
  py::class_<typename frc::ExponentialProfile<Distance, Input>::State, py::smart_holder> cls_State;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ExponentialProfile
      ...
      .def("calculate", &frc::ExponentialProfile<Distance, Input>::Calculate
        , py::arg("t"), py::arg("current"), py::arg("goal")
        , release_gil()
        , py::doc(
      ...
      .def("calculateInflectionPoint", static_cast<State (frc::ExponentialProfile<Distance, Input>::*)(const State&, const State&) const>(&frc::ExponentialProfile<Distance, Input>::CalculateInflectionPoint)
        , py::arg("current"), py::arg("goal")
        , release_gil()
        , py::doc(
      ...
      .def("timeLeftUntil", &frc::ExponentialProfile<Distance, Input>::TimeLeftUntil
        , py::arg("current"), py::arg("goal")
        , release_gil()
        , py::doc(
      ...
      .def("calculateProfileTiming", static_cast<ProfileTiming (frc::ExponentialProfile<Distance, Input>::*)(const State&, const State&) const>(&frc::ExponentialProfile<Distance, Input>::CalculateProfileTiming)
        , py::arg("current"), py::arg("goal")
        , release_gil()
        , py::doc(
    ...
    ;
    cls_ProfileTiming.doc() = "Profile timing.";
    cls_ProfileTiming
      .def(py::init<>(), release_gil())
      .def("isFinished", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::IsFinished
        , py::arg("t")
        , release_gil()
        , py::doc(
      ...
      .def_readonly("inflectionTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::inflectionTime, py::doc("Profile inflection time."))
      .def_readonly("totalTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::totalTime, py::doc("Total profile time."))
    ;
    cls_Constraints.doc() = "Profile constraints.";
    cls_Constraints
      .def("maxVelocity", &frc::ExponentialProfile<Distance, Input>::Constraints::MaxVelocity
        , release_gil()
        , py::doc(
      ...
      .def_readonly("maxInput", &frc::ExponentialProfile<Distance, Input>::Constraints::maxInput, py::doc("Maximum unsigned input voltage."))
      .def_readonly("A", &frc::ExponentialProfile<Distance, Input>::Constraints::A, py::doc("The State-Space 1x1 system matrix."))
      .def_readonly("B", &frc::ExponentialProfile<Distance, Input>::Constraints::B, py::doc("The State-Space 1x1 input matrix."))
    ...
    ;
    cls_State.doc() = "Profile state.";
    cls_State
      .def(py::self == py::self
      )
      .def_readonly("position", &frc::ExponentialProfile<Distance, Input>::State::position, py::doc("The position at this state."))
      .def_readonly("velocity", &frc::ExponentialProfile<Distance, Input>::State::velocity, py::doc("The velocity at this state."))
