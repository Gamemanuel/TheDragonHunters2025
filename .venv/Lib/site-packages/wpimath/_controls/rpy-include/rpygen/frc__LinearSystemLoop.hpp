...
struct bind_frc__LinearSystemLoop {
  ...
  py::class_<typename frc::LinearSystemLoop<States, Inputs, Outputs>, py::smart_holder> cls_LinearSystemLoop;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_LinearSystemLoop
      .def(py::init<LinearSystem<States, Inputs, Outputs>&, LinearQuadraticRegulator<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, units::volt_t, units::second_t>()
        , py::arg("plant"), py::arg("controller"), py::arg("observer"), py::arg("maxVoltage"), py::arg("dt")
      ...
      .def(py::init<LinearSystem<States, Inputs, Outputs>&, LinearQuadraticRegulator<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector (const InputVector&)>, units::second_t>()
        , py::arg("plant"), py::arg("controller"), py::arg("observer"), py::arg("clampFunction").none(false), py::arg("dt")
        , release_gil(), py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::keep_alive<1, 4>()
        , py::doc(
        "Constructs a state-space loop with the given plant, controller, and\n"
        "observer. By default, the initial reference is all zeros. Users should\n"
      ...
      .def(py::init<LinearQuadraticRegulator<States, Inputs>&, const LinearPlantInversionFeedforward<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, units::volt_t>()
        , py::arg("controller"), py::arg("feedforward"), py::arg("observer"), py::arg("maxVoltage")
        , release_gil(), py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::keep_alive<1, 4>()
        , py::doc(
      ...
      .def(py::init<LinearQuadraticRegulator<States, Inputs>&, const LinearPlantInversionFeedforward<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector (const InputVector&)>>()
        , py::arg("controller"), py::arg("feedforward"), py::arg("observer"), py::arg("clampFunction").none(false)
        , release_gil(), py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::keep_alive<1, 4>()
        , py::doc(
      ...
      .def("xhat", static_cast<const StateVector& (frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::Xhat)
        , release_gil()
        , py::doc("Returns the observer's state estimate x-hat.")
      )
      .def("xhat", static_cast<double (frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::Xhat)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("nextR", static_cast<const StateVector& (frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::NextR)
        , release_gil()
        , py::doc("Returns the controller's next reference r.")
      )
      .def("nextR", static_cast<double (frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::NextR)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("U", static_cast<InputVector (frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::U)
        , release_gil()
        , py::doc("Returns the controller's calculated control input u.")
      )
      .def("U", static_cast<double (frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(&frc::LinearSystemLoop<States, Inputs, Outputs>::U)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::LinearSystemLoop<States, Inputs, Outputs>::*)(const StateVector&)>(&frc::LinearSystemLoop<States, Inputs, Outputs>::SetXhat)
        , py::arg("xHat")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int, double)>(&frc::LinearSystemLoop<States, Inputs, Outputs>::SetXhat)
      ...
      .def("error", &frc::LinearSystemLoop<States, Inputs, Outputs>::Error
        , release_gil()
        , py::doc("Returns difference between reference r and current state x-hat.")
      )
