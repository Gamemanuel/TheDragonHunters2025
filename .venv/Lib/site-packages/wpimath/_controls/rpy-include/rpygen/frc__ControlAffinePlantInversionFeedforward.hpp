...
struct bind_frc__ControlAffinePlantInversionFeedforward {
  ...
  py::class_<typename frc::ControlAffinePlantInversionFeedforward<States, Inputs>, py::smart_holder> cls_ControlAffinePlantInversionFeedforward;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ControlAffinePlantInversionFeedforward
      ...
      .def(py::init<std::function<StateVector (const StateVector&)>, const Matrixd<States, Inputs>&, units::second_t>()
        , py::arg("f").none(false), py::arg("B"), py::arg("dt")
        , release_gil(), py::keep_alive<1, 3>()
        , py::doc(
      ...
      .def("uff", static_cast<const InputVector& (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)() const>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Uff)
        , release_gil()
        , py::doc(
      ...
      .def("uff", static_cast<double (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(int) const>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Uff)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("R", static_cast<const StateVector& (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)() const>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::R)
        , release_gil()
        , py::doc(
      ...
      .def("R", static_cast<double (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(int) const>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::R)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("reset", static_cast<void (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const StateVector&)>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Reset)
        , py::arg("initialState")
        , release_gil()
        , py::doc(
      ...
      .def("reset", static_cast<void (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)()>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Reset)
        , release_gil()
        , py::doc("Resets the feedforward with a zero initial state vector.")
      )
      .def("calculate", static_cast<InputVector (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const StateVector&)>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Calculate)
        , py::arg("nextR")
        , release_gil()
        , py::doc(
      ...
      .def("calculate", static_cast<InputVector (frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const StateVector&, const StateVector&)>(&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Calculate)
        , py::arg("r"), py::arg("nextR")
        , release_gil()
        , py::doc(
