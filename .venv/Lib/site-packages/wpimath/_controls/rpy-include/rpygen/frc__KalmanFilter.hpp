...
struct bind_frc__KalmanFilter {
  ...
  py::class_<typename frc::KalmanFilter<States, Inputs, Outputs>, py::smart_holder> cls_KalmanFilter;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_KalmanFilter
      .def(py::init<LinearSystem<States, Inputs, Outputs>&, const StateArray&, const OutputArray&, units::second_t>()
        , py::arg("plant"), py::arg("stateStdDevs"), py::arg("measurementStdDevs"), py::arg("dt")
      ...
      .def("P", static_cast<const StateMatrix& (frc::KalmanFilter<States, Inputs, Outputs>::*)() const>(&frc::KalmanFilter<States, Inputs, Outputs>::P)
        , release_gil()
        , py::doc("Returns the error covariance matrix P.")
      )
      .def("P", static_cast<double (frc::KalmanFilter<States, Inputs, Outputs>::*)(int, int) const>(&frc::KalmanFilter<States, Inputs, Outputs>::P)
        , py::arg("i"), py::arg("j")
        , release_gil()
        , py::doc(
      ...
      .def("setP", &frc::KalmanFilter<States, Inputs, Outputs>::SetP
        , py::arg("P")
        , release_gil()
        , py::doc(
      ...
      .def("xhat", static_cast<const StateVector& (frc::KalmanFilter<States, Inputs, Outputs>::*)() const>(&frc::KalmanFilter<States, Inputs, Outputs>::Xhat)
        , release_gil()
        , py::doc("Returns the state estimate x-hat.")
      )
      .def("xhat", static_cast<double (frc::KalmanFilter<States, Inputs, Outputs>::*)(int) const>(&frc::KalmanFilter<States, Inputs, Outputs>::Xhat)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::KalmanFilter<States, Inputs, Outputs>::*)(const StateVector&)>(&frc::KalmanFilter<States, Inputs, Outputs>::SetXhat)
        , py::arg("xHat")
        , release_gil()
        , py::doc(
      ...
      .def("setXhat", static_cast<void (frc::KalmanFilter<States, Inputs, Outputs>::*)(int, double)>(&frc::KalmanFilter<States, Inputs, Outputs>::SetXhat)
      ...
      .def("reset", &frc::KalmanFilter<States, Inputs, Outputs>::Reset
        , release_gil()
      ...
      .def("correct", static_cast<void (frc::KalmanFilter<States, Inputs, Outputs>::*)(const InputVector&, const OutputVector&)>(&frc::KalmanFilter<States, Inputs, Outputs>::Correct)
        , py::arg("u"), py::arg("y")
        , release_gil()
        , py::doc(
      ...
      .def("correct", static_cast<void (frc::KalmanFilter<States, Inputs, Outputs>::*)(const InputVector&, const OutputVector&, const Matrixd<Outputs, Outputs>&)>(&frc::KalmanFilter<States, Inputs, Outputs>::Correct)
