...
struct bind_frc__TrapezoidProfile {
  ...
  py::class_<typename frc::TrapezoidProfile<Distance>, py::smart_holder> cls_TrapezoidProfile;
  py::class_<typename frc::TrapezoidProfile<Distance>::Constraints, py::smart_holder> cls_Constraints;
  py::class_<typename frc::TrapezoidProfile<Distance>::State, py::smart_holder> cls_State;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_TrapezoidProfile
      ...
      .def("totalTime", &frc::TrapezoidProfile<Distance>::TotalTime
        , release_gil()
        , py::doc(
    ...
    cls_Constraints
      ...
      .def_readonly("maxVelocity", &frc::TrapezoidProfile<Distance>::Constraints::maxVelocity, py::doc("Maximum velocity."))
      .def_readonly("maxAcceleration", &frc::TrapezoidProfile<Distance>::Constraints::maxAcceleration, py::doc("Maximum acceleration."))
    ;
    cls_State.doc() = "Profile state.";
    cls_State
      .def(py::self == State()
      )
      .def_readonly("position", &frc::TrapezoidProfile<Distance>::State::position, py::doc("The position at this state."))
      .def_readonly("velocity", &frc::TrapezoidProfile<Distance>::State::velocity, py::doc("The velocity at this state."))
    ;
    if (set_doc) {
