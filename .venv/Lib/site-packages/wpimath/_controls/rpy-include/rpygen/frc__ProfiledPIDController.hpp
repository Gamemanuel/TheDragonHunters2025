...
template <typename Distance, typename CfgBase = rpygen::EmptyTrampolineCfg>
...
struct bind_frc__ProfiledPIDController {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ProfiledPIDController
      ...
      .def("setIZone", &frc::ProfiledPIDController<Distance>::SetIZone
        , py::arg("iZone")
        , release_gil()
        , py::doc(
      ...
      .def("getP", &frc::ProfiledPIDController<Distance>::GetP
        , release_gil()
        , py::doc(
      ...
      .def("getI", &frc::ProfiledPIDController<Distance>::GetI
        , release_gil()
        , py::doc(
      ...
      .def("getD", &frc::ProfiledPIDController<Distance>::GetD
        , release_gil()
        , py::doc(
      ...
      .def("getIZone", &frc::ProfiledPIDController<Distance>::GetIZone
        , release_gil()
        , py::doc(
        "Get the IZone range.\n"
        "\n"
      ...
      .def("getPeriod", &frc::ProfiledPIDController<Distance>::GetPeriod
        , release_gil()
        , py::doc(
      ...
      .def("getPositionTolerance", &frc::ProfiledPIDController<Distance>::GetPositionTolerance
        , release_gil()
        , py::doc(
      ...
      .def("getVelocityTolerance", &frc::ProfiledPIDController<Distance>::GetVelocityTolerance
        , release_gil()
        , py::doc(
      ...
      .def("getAccumulatedError", &frc::ProfiledPIDController<Distance>::GetAccumulatedError
        , release_gil()
        , py::doc(
      ...
      .def("setGoal", static_cast<void (frc::ProfiledPIDController<Distance>::*)(State)>(&frc::ProfiledPIDController<Distance>::SetGoal)
        , py::arg("goal")
        , release_gil()
        , py::doc(
      ...
      .def("setGoal", static_cast<void (frc::ProfiledPIDController<Distance>::*)(Distance_t)>(&frc::ProfiledPIDController<Distance>::SetGoal)
        , py::arg("goal")
        , release_gil()
        , py::doc(
        "Sets the goal for the ProfiledPIDController.\n"
      ...
      .def("getGoal", &frc::ProfiledPIDController<Distance>::GetGoal
        , release_gil()
        , py::doc("Gets the goal for the ProfiledPIDController.")
      )
      .def("atGoal", &frc::ProfiledPIDController<Distance>::AtGoal
        , release_gil()
        , py::doc(
      ...
      .def("getConstraints", &frc::ProfiledPIDController<Distance>::GetConstraints
        , release_gil()
        , py::doc(
      ...
      .def("getSetpoint", &frc::ProfiledPIDController<Distance>::GetSetpoint
        , release_gil()
        , py::doc(
      ...
      .def("atSetpoint", &frc::ProfiledPIDController<Distance>::AtSetpoint
        , release_gil()
        , py::doc(
        "Returns true if the error is within the tolerance of the error.\n"
        "\n"
      ...
      .def("disableContinuousInput", &frc::ProfiledPIDController<Distance>::DisableContinuousInput
        , release_gil()
      ...
      .def("getPositionError", &frc::ProfiledPIDController<Distance>::GetPositionError
        , release_gil()
        , py::doc(
      ...
      .def("getVelocityError", &frc::ProfiledPIDController<Distance>::GetVelocityError
        , release_gil()
        , py::doc("Returns the change in error per second.")
      )
      .def("calculate", static_cast<double (frc::ProfiledPIDController<Distance>::*)(Distance_t)>(&frc::ProfiledPIDController<Distance>::Calculate)
        , py::arg("measurement")
        , release_gil()
        , py::doc(
      ...
      .def("calculate", static_cast<double (frc::ProfiledPIDController<Distance>::*)(Distance_t, State)>(&frc::ProfiledPIDController<Distance>::Calculate)
      ...
      .def("calculate", static_cast<double (frc::ProfiledPIDController<Distance>::*)(Distance_t, Distance_t)>(&frc::ProfiledPIDController<Distance>::Calculate)
        , py::arg("measurement"), py::arg("goal")
        , release_gil()
        , py::doc(
        "Returns the next output of the PID controller.\n"
      ...
      .def("calculate", static_cast<double (frc::ProfiledPIDController<Distance>::*)(Distance_t, Distance_t, typename TrapezoidProfile<Distance>::Constraints)>(&frc::ProfiledPIDController<Distance>::Calculate)
      ...
      .def("reset", static_cast<void (frc::ProfiledPIDController<Distance>::*)(const State&)>(&frc::ProfiledPIDController<Distance>::Reset)
        , py::arg("measurement")
        , release_gil()
        , py::doc(
      ...
      .def("reset", static_cast<void (frc::ProfiledPIDController<Distance>::*)(Distance_t, Velocity_t)>(&frc::ProfiledPIDController<Distance>::Reset)
      ...
      .def("reset", static_cast<void (frc::ProfiledPIDController<Distance>::*)(Distance_t)>(&frc::ProfiledPIDController<Distance>::Reset)
