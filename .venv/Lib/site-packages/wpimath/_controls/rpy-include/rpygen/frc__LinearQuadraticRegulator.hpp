...
struct bind_frc__LinearQuadraticRegulator {
  ...
  py::class_<typename frc::LinearQuadraticRegulator<States, Inputs>, py::smart_holder> cls_LinearQuadraticRegulator;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_LinearQuadraticRegulator
      .def(py::init<const Matrixd<States, States>&, const Matrixd<States, Inputs>&, const StateArray&, const InputArray&, units::second_t>()
        , py::arg("A"), py::arg("B"), py::arg("Qelems"), py::arg("Relems"), py::arg("dt")
      ...
      .def(py::init<const Matrixd<States, States>&, const Matrixd<States, Inputs>&, const Matrixd<States, States>&, const Matrixd<Inputs, Inputs>&, units::second_t>()
        , py::arg("A"), py::arg("B"), py::arg("Q"), py::arg("R"), py::arg("dt")
        , release_gil(), py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::keep_alive<1, 4>(), py::keep_alive<1, 5>()
        , py::doc(
        "Constructs a controller with the given coefficients and plant.\n"
        "\n"
      ...
      .def(py::init<const Matrixd<States, States>&, const Matrixd<States, Inputs>&, const Matrixd<States, States>&, const Matrixd<Inputs, Inputs>&, const Matrixd<States, Inputs>&, units::second_t>()
        , py::arg("A"), py::arg("B"), py::arg("Q"), py::arg("R"), py::arg("N"), py::arg("dt")
        , release_gil(), py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::keep_alive<1, 4>(), py::keep_alive<1, 5>(), py::keep_alive<1, 6>()
        , py::doc(
        "Constructs a controller with the given coefficients and plant.\n"
        "\n"
        ":param A:  Continuous system matrix of the plant being controlled.\n"
      ...
      .def("K", static_cast<const Matrixd<Inputs, States>& (frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(&frc::LinearQuadraticRegulator<States, Inputs>::K)
        , release_gil()
        , py::doc("Returns the controller matrix K.")
      )
      .def("K", static_cast<double (frc::LinearQuadraticRegulator<States, Inputs>::*)(int, int) const>(&frc::LinearQuadraticRegulator<States, Inputs>::K)
        , py::arg("i"), py::arg("j")
        , release_gil()
        , py::doc(
      ...
      .def("R", static_cast<const StateVector& (frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(&frc::LinearQuadraticRegulator<States, Inputs>::R)
        , release_gil()
        , py::doc(
      ...
      .def("R", static_cast<double (frc::LinearQuadraticRegulator<States, Inputs>::*)(int) const>(&frc::LinearQuadraticRegulator<States, Inputs>::R)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("U", static_cast<const InputVector& (frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(&frc::LinearQuadraticRegulator<States, Inputs>::U)
        , release_gil()
        , py::doc(
      ...
      .def("U", static_cast<double (frc::LinearQuadraticRegulator<States, Inputs>::*)(int) const>(&frc::LinearQuadraticRegulator<States, Inputs>::U)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("reset", &frc::LinearQuadraticRegulator<States, Inputs>::Reset
        , release_gil()
        , py::doc("Resets the controller.")
      )
      .def("calculate", static_cast<InputVector (frc::LinearQuadraticRegulator<States, Inputs>::*)(const StateVector&)>(&frc::LinearQuadraticRegulator<States, Inputs>::Calculate)
        , py::arg("x")
        , release_gil()
        , py::doc(
      ...
      .def("calculate", static_cast<InputVector (frc::LinearQuadraticRegulator<States, Inputs>::*)(const StateVector&, const StateVector&)>(&frc::LinearQuadraticRegulator<States, Inputs>::Calculate)
        , py::arg("x"), py::arg("nextR")
        , release_gil()
        , py::doc(
        "Returns the next output of the controller.\n"
        "\n"
      ...
      .def("latencyCompensate", &frc::LinearQuadraticRegulator<States, Inputs>::template LatencyCompensate<1>
        , py::arg("plant"), py::arg("dt"), py::arg("inputDelay")
        , release_gil()
        , py::doc(
      ...
      .def("latencyCompensate", &frc::LinearQuadraticRegulator<States, Inputs>::template LatencyCompensate<2>
        , py::arg("plant"), py::arg("dt"), py::arg("inputDelay")
        , release_gil()
        , py::doc(
        "Adjusts LQR controller gain to compensate for a pure time delay in the\n"
