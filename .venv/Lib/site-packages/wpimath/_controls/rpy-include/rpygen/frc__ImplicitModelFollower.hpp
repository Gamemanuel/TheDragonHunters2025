...
struct bind_frc__ImplicitModelFollower {
  ...
  py::class_<typename frc::ImplicitModelFollower<States, Inputs>, py::smart_holder> cls_ImplicitModelFollower;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_ImplicitModelFollower
      .def(py::init<const Matrixd<States, States>&, const Matrixd<States, Inputs>&, const Matrixd<States, States>&, const Matrixd<States, Inputs>&>()
        , py::arg("A"), py::arg("B"), py::arg("Aref"), py::arg("Bref")
      ...
      .def("U", static_cast<const InputVector& (frc::ImplicitModelFollower<States, Inputs>::*)() const>(&frc::ImplicitModelFollower<States, Inputs>::U)
        , release_gil()
        , py::doc(
      ...
      .def("U", static_cast<double (frc::ImplicitModelFollower<States, Inputs>::*)(int) const>(&frc::ImplicitModelFollower<States, Inputs>::U)
        , py::arg("i")
        , release_gil()
        , py::doc(
      ...
      .def("reset", &frc::ImplicitModelFollower<States, Inputs>::Reset
        , release_gil()
        , py::doc("Resets the controller.")
      )
      .def("calculate", &frc::ImplicitModelFollower<States, Inputs>::Calculate
        , py::arg("x"), py::arg("u")
        , release_gil()
        , py::doc(
