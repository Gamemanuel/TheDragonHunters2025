...
struct bind_frc__SimulatedAnnealing {
  py::class_<typename frc::SimulatedAnnealing<State>, py::smart_holder> cls_SimulatedAnnealing;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SimulatedAnnealing
      .def(py::init<double, std::function<State (const State&)>, std::function<double (const State&)>>()
        , py::arg("initialTemperature"), py::arg("neighbor").none(false), py::arg("cost").none(false)
        , release_gil()
        , py::doc(
      ...
      .def("solve", &frc::SimulatedAnnealing<State>::Solve
        , py::arg("initialGuess"), py::arg("iterations")
        , release_gil()
        , py::doc(
