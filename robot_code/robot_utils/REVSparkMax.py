from rev         import SparkMax       as REVSparkMax
...
class REVSparkMax(REVSparkMax):
    ...
    # REVSparkMax Config
    def setConfig(self, reset_mode: REVResetMode, persist_mode: REVPersistMode) -> None:
        ...
        """
        self.configure(self.getConfig(), reset_mode, persist_mode)
    ...
    def resetConfig(self) -> None:
        ...
        self.setConfig(SAFE_RESET, NO_PERSIST)
